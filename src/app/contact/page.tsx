    ...
    return (
        <div className="w-full py-20  text-white">
            ...
            <div className="max-w-xl mx-auto px-4">
                <Card className="bg-gray-600/50 p-6 border-none">
                    <Card className="bg-gray-800/60 p-6 border-none">
                        <h1 className={`text-3xl ${warna1}`}>
                            {language === "en" ? "Get In Touch" : "Hubungi Saya"}</h1>
                        <p className=" text-white text-lg">{language === "en" ? "Have something to discuss? Send me a message and let's talk" :
                            "Ada yang ingin didiskusikan? Kirim pesan dan ayo kita ngobrol"}</p>

                        <form
                            action="https://formspree.io/f/mjkrjgpk" // ganti dengan form ID kamu
                            method="POST"
                            className="space-y-4"
                            target="_blank"
                        >
